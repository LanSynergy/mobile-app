...
abstract final class AfTypography {
  ...
  static TextStyle get titleSmall =>
      _inter(fontSize: 16, height: 22 / 16, weight: FontWeight.w600);

  static TextStyle get bodyLarge =>
      _inter(fontSize: 16, height: 24 / 16, weight: FontWeight.w400);

  static TextStyle get bodyMedium =>
      _inter(fontSize: 14, height: 20 / 14, weight: FontWeight.w400);
