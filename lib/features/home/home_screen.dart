                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Spacer(),
                      _GlassSearchButton(onTap: () => context.push('/search')),
                    ],
                  ),
                ),
              ),
                ...
                data: (home) {
                  ...
                  return SliverToBoxAdapter(
                    child: Padding(
                      ...
                      child: _YouTubeChipsRow(chips: home.chips),
                    ),
                  );
                },
...
class _GlassSearchButton extends StatelessWidget {
  const _GlassSearchButton({required this.onTap});
  final VoidCallback onTap;
...
class _YouTubeChipsRow extends ConsumerWidget {
  const _YouTubeChipsRow({required this.chips});
...
class _YouTubeSongGrid extends ConsumerWidget {
  const _YouTubeSongGrid({required this.items});
...
class _YouTubeHomeTileList extends ConsumerWidget {
  const _YouTubeHomeTileList({required this.items});
  final List<InnerTubeItem> items;
