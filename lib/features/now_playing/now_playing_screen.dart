              ...
              child: Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [
                      Colors.transparent,
                      AfColors.surfaceCanvas.withValues(alpha: 0.15),
                      AfColors.surfaceCanvas.withValues(alpha: 0.30),
                      AfColors.surfaceCanvas.withValues(alpha: 0.45),
                      AfColors.surfaceCanvas.withValues(alpha: 0.55),
                      AfColors.surfaceCanvas.withValues(alpha: 0.65),
                      AfColors.surfaceCanvas.withValues(alpha: 0.75),
                      AfColors.surfaceCanvas.withValues(alpha: 0.85),
                    ],
                    stops: const [0.0, 0.14, 0.29, 0.43, 0.55, 0.68, 0.82, 1.0],
                  ),
                ),
              ),
            ),
