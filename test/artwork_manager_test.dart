...
void main() {
  ...
  group('AfArtworkManager', () {
    ...
    test(
      'downloadArtworkForNotification does not delete embedded cover file',
      () async {
    ...
    test(
      'downloadArtworkForNotification with non-200 response drains and returns early',
      () async {
    ...
    test(
      'downloadArtworkForNotification deduplicates download for same track',
      () async {
        const track = AfTrack(
          id: 'track1',
          title: 'T',
