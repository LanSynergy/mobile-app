...
<p align="center">
  <img src="assets/screencapture/now-playing.jpg" width="23%" hspace="4" alt="Now Playing">
  <img src="assets/screencapture/queue.jpg" width="23%" hspace="4" alt="Queue">
  <img src="assets/screencapture/library.jpg" width="23%" hspace="4" alt="Library">
  <img src="assets/screencapture/lyrics.jpg" width="23%" hspace="4" alt="Lyrics">
</p>
...
└─────────────────────────────┘       └────────────────────────────┘
  ...
  Or: local files on your device → direct playback, no server needed.
```
...
No analytics. No ads. No trackers. No Aetherfin servers. The app talks only to the server you configure — or plays local files without any network at all. Full details in [PRIVACY.md](./PRIVACY.md).
